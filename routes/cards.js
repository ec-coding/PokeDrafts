...
// // @route   PUT /
router.get('/putCardName', ensureAuth, cardsController.putCardName)
...
router.post('/createDeckCard', ensureAuth, cardsController.createDeckCard)

// @desc    Counts how many cards a user has in their deck
// @route   GET /countDeckCard
router.get('/countDeckCard', ensureAuth, cardsController.countDeckCard)
...
router.delete('/deleteDeck', ensureAuth, cardsController.deleteDeck)
